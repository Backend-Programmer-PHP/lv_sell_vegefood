    ...
    <div class="sidebar-inner px-4 pt-3">
            ...
            <div
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="{{ !auth()->user()->photo ? '' : auth()->user()->photo }}"
                            class="card-img-top rounded-circle border-white" alt="Bonnie Green">
                    </div>
                    <div class="d-block">
                        <h2 class="h5 mb-3">{{ auth()->user()->name }}</h2>
                        <a href="{{ route('logout') }}"
                            class="btn btn-secondary btn-sm d-inline-flex align-items-center"  onclick="event.preventDefault();
        ...
        @else
            <div
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="{{ asset('public/dashboard/assets/img/team/profile-picture-3.jpg') }}"
                            class="card-img-top rounded-circle border-white" alt="Bonnie Green">
                    </div>
                    <div class="d-block">
            ...
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset('public/dashboard/assets/img/brand/light.svg') }}" height="20" width="20"
                            alt="Volt Logo">
                    </span>
                    ...
                    <ul class="flex-column nav">
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('product.index') }}">
                                <span class="sidebar-text">All Product</span>
                            </a>
                        </li>
                        <li class="nav-item ">
