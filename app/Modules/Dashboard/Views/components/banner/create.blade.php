    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('banner.create') }}">New Banner</a></li>
                <li class="breadcrumb-item active" aria-current="page">Banners</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Add Banner</h1>
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card border-0 shadow components-section">
                <!-- Form -->
                <form action="{{route('banner.store')}}" method="POST" class="navbar-search form-inline" id="navbar-search-main" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" class="form-control @error('name') is-invalid @enderror" id="usernameValidate" placeholder="Headline">
                                    @error('title')
