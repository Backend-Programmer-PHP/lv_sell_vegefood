                ...
                <tbody>
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td><span class="fw-normal">{{ $product->categories_name }}</span></td>
                            @if ($product->photo)
                                <td>
                            ...
                            @else
                                <td><span class="fw-bold text-warning">inactive</span></td>
                            @endif
                            <td>
                                <div class="btn-group">
        ...
        <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
            <nav aria-label="Page navigation example">
                <ul class="pagination mb-0">
                    @if ($products->currentPage() > 1 && $products->total() > 1)
                        <li class="page-item">
                            <a class="page-link"
                                href="{{ url('/products') }}?page={{ $pagePrevious }}">Previous</a>
                        </li>
                    @endif
                    @for ($i = 1; $i <= $total_pages; $i++)
                        @if ($i == $products->currentPage())
                            <li class="page-item active">
                                <a class="page-link" href="{{ url('/products') }}?page={{ $i }}">
                                    {{ $i }}</a>
                            </li>
                        @else
                            <li class="page-item">
                    ...
                    @if ($products->currentPage() < $products->total() && $products->total() > 1)
                        <li class="page-item">
                            <a class="page-link" href="{{ url('/products') }}?page={{ $pageNext }}">Next</a>
                        </li>
                    @endif
                </ul>
            ...
            <div class="fw-normal small mt-4 mt-lg-0">Showing <b>{{ $products->perPage() }}</b> out of
