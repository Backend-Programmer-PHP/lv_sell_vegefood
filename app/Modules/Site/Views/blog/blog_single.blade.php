        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 ftco-animate">
                    ...
                    <p>
                        <img src="{{ asset('public/site/images/image_1.jpg')}}" alt="" class="img-fluid">
                    </p>
                    ...
                    <p>
                        <img src="{{ asset('public/site/images/image_2.jpg')}}" alt="" class="img-fluid">
                    </p>
                    ...
                    <div class="about-author d-flex p-4 bg-light">
                        <div class="bio align-self-md-center mr-4">
                            <img src="{{ asset('public/site/images/person_1.jpg')}}" alt="Image placeholder" class="img-fluid mb-4">
                        </div>
                   ...
                   @include('Site::blog.blog_comment')
                </div> <!-- .col-md-8 -->
                 {{-- Left tab--}}
